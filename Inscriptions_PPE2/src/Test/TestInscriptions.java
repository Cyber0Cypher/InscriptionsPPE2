...
public class TestInscriptions extends TestCase {
	...
	public void testCreateCompetition() {
		Competition compet2 = i.createCompetition("Competition 2", null, true);
		compet.delete();
	...
	public void testCreatePersonne() {
		Personne p2 = i.createPersonne("Claude", "Jean", "jean.claude@mail.com");
		p1.delete();
